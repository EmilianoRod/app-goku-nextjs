...
describe('Pruebas en FAQS por ID', () => {
    test('Debe retornar un FAQ', async () => {
        ...
        // Llamamos a la funcion manejadora de la API
    ...
    test('Debe retornar un mensaje si el metodo no esta permitido', async () => {
        // Creamos el objeto simulaod de la solicitud (req)
        const req = httpMocks.createRequest<NextApiRequest>({
            method: "POST",
            query: {
                id: 2
